...
class Students(models.Model):
    ...
    research_adviser_first_name = models.CharField(max_length=100, null=True, blank=True)
    research_adviser_last_name = models.CharField(max_length=100, null=True, blank=True)
...
class Scores_Round_1(models.Model):
    ...
    def get_average_scores():
        ...
        scores = Scores_Round_1.objects.filter(
            ...
            avg_research_score = Round(Avg('research_score', output_field=models.FloatField()), 2),
            avg_communication_score = Round(Avg('communication_score', output_field=models.FloatField()), 2),
            avg_presentation_score = Round(Avg('presentation_score', output_field=models.FloatField()), 2),
