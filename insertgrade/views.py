...
from precheckposter.views import check_poster_round_1, check_poster_round_2, check_poster_round_1_edit, check_poster_round_2_edit
...
class round2_insert(APIView):
    ...
    def get(self, request, poster_id):
        ...
        poster_status = check_poster_round_2(poster_id, request.user)
...
class round1_edit(APIView):
    ...
    def get(self, request, poster_id):
        ...
        poster_status = check_poster_round_1_edit(poster_id, request.user)
        ...
        if poster_status == 1:
            ...
            return Response({"poster_id": poster_id, "poster_title": poster_title, "student_name": student_name, "student_email": student_email, "student_department": student_department, "research_score": research_score, "communication_score": communication_score, "presentation_score": presentation_score}, status=status.HTTP_200_OK)
        elif poster_status == 2:
            return Response({"error": "Invalid Poster ID"}, status=status.HTTP_400_BAD_REQUEST)
        elif poster_status == 3:
    ...
    def post(self, request):
        ...
        if poster_status == 1:
            ...
            scores_round_1 = Scores_Round_1.objects.filter(Student=student, judge=request.user).first()
...
class round2_edit(APIView):
    ...
    def get(self, request, poster_id):
        ...
        poster_status = check_poster_round_2_edit(poster_id, request.user)
        ...
        if poster_status == 1:
            ...
            student_email = poster.email
            student_department = poster.department
            # get the research score, communication score, and presentation score from Scores_Round_2
            scores_round_2 = Scores_Round_2.objects.filter(Student=poster, judge=request.user).first()
            research_score = scores_round_2.research_score
            communication_score = scores_round_2.communication_score
            presentation_score = scores_round_2.presentation_score
    ...
    def post(self, request):
        ...
        if poster_status == 1:
            ...
            scores_round_2 = Scores_Round_2.objects.filter(Student=student, judge=request.user).first()

            scores_round_2.research_score = research_score
            scores_round_2.communication_score = communication_score
            scores_round_2.presentation_score = presentation_score
            scores_round_2.save()
