...
from .views import round1_insert, round2_insert, round1_edit, round2_edit

app_name = 'insertgrade'

urlpatterns = [
    path('round1_insert/<str:poster_id>/', round1_insert.as_view(), name='round1_insert'),
    ...
    path('round1_edit/<str:poster_id>/', round1_edit.as_view(), name='round1_edit'),
